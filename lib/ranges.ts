...
const VS3BET_DATA: Partial<Record<Position, Partial<Record<AnySeat, Vs3betSpot>>>> = {
  UTG: {
    ...
    CO: {
      ...
      partial: {
        "K7s": 0.41, "QJo": 0.53, "J9s": 0.78, "KTo": 0.38, "QTo": 0.07, "T8s": 0.09, "T2s": 0.23,
  ...
  HJ: {
    CO: {
      ...
      fold: [
        ...
        "AJo", "KJo", "QJo", "J8s", "ATo", "KTo", "QTo", "JTo", "T8s", "T2s", "A9o",
      ],
      mixes: {
      ...
      partial: {
        "K6s": 0.71, "K5s": 0.63, "Q8s": 0.52, "J8s": 0.11, "QTo": 0.55, "JTo": 0.33, "T2s": 0.23,
        "A9o": 0.6, "98s": 0.88, "87s": 0.36, "76s": 0.41, "65s": 0.65, "54s": 0.5, "44": 0.56,
        "33": 0.31, "22": 0.16,
      },
    },
  },
  CO: {
    SB: {
      ...
      partial: {
        ...
        "86s": 0.11, "A7o": 0.11, "76s": 0.77, "65s": 0.76, "A5o": 0.64, "54s": 0.57, "74o": 0.12,
        "33": 0.9, "22": 0.41,
      },
    },
  },
  SB: {
    BB: {
      ...
      fold: [
        ...
        "QTo", "T6s", "T2s", "A9o", "K9o", "Q9o", "J9o", "T9o", "96s", "A8o", "K8o", "T8o", "98o",
        "86s", "85s", "A7o", "87o", "75s", "74s", "A6o", "64s", "A5o", "53s", "A4o", "A3o",
      ],
      mixes: {
      ...
      partial: {
        "T2s": 0.23, "K8o": 0.92, "T8o": 0.7, "98o": 0.72, "87o": 0.2, "74s": 0.47, "A3o": 0.32,
      },
    },
  },
};
